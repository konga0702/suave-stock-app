...
import { Package, Repeat2, LayoutDashboard, ScanSearch, TrendingUp } from 'lucide-react'

const navItems = [
  { path: '/', label: 'ホーム', icon: LayoutDashboard },
  { path: '/products', label: '在庫', icon: Package },
  { path: '/transactions', label: '作業', icon: Repeat2 },
  { path: '/inventory', label: '追跡', icon: ScanSearch },
  { path: '/profit', label: 'その他', icon: TrendingUp },
]
